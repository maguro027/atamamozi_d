...
public class Menus {
     ...
     public static Inventory getRaceList(Player player) {
          ...
          for (int i = 0; i < Race_Core.Race_list.size(); i++) RACE_LIST.setItem(i + 9, new ItemStack(getRace(Race_Core.Race_list.get(i), player)));
          return RACE_LIST;
     }
     ...
     public static Inventory getRaceRanking(Player player) {
          ...
          for (int i = 0; i < Race_Core.Race_list.size(); i++) RACE_RANKING.setItem(i + 9, new ItemStack(getRaceRank(Race_Core.Race_list.get(i), player)));
          return RACE_RANKING;
     }
