...
public class Menus {
	...
	public static Inventory getRaceCreate(Player player) {
		...
		RACE_CREATE.setItem(19, new ItemStack(SET_NAME));
		RACE_CREATE.setItem(21, new ItemStack(RACE_TYPE));
		RACE_CREATE.setItem(23, new ItemStack(AMOUNT));
		RACE_CREATE.setItem(25, new ItemStack(ICON));
		RACE_CREATE.setItem(40, new ItemStack(CHECKPOINT));
